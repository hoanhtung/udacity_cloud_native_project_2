...
import common.proto.location_pb2 as location__pb2
...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Create = channel.unary_unary(
                ...
                response_deserializer=location__pb2.Empty.FromString,
                )
        self.Retrieve = channel.unary_unary(
                '/LocationService/Retrieve',
                request_serializer=location__pb2.RetrieveLocationRequest.SerializeToString,
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Create': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=location__pb2.Empty.SerializeToString,
            ),
            'Retrieve': grpc.unary_unary_rpc_method_handler(
                    servicer.Retrieve,
                    request_deserializer=location__pb2.RetrieveLocationRequest.FromString,
...
class LocationService(object):
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/LocationService/Create',
            ...
            location__pb2.Empty.FromString,
    ...
    def Retrieve(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/LocationService/Retrieve',
            location__pb2.RetrieveLocationRequest.SerializeToString,
